//
// HourlyHistoricalWeatherDataAPI.swift
//
...
open class HourlyHistoricalWeatherDataAPI {
    ...
    ///
    public enum HistoryHourlycityIdcityIdGetUnits: String, Codable, CaseIterable {
        case s = "S"
        case i = "I"
    }
    ///
    ...
    ///
    public enum HistoryHourlycityIdcityIdGetLang: String, Codable, CaseIterable {
        case ar = "ar"
        case az = "az"
        case be = "be"
        case bg = "bg"
    ...
    ///
    public enum HistoryHourlycityIdcityIdGetTz: String, Codable, CaseIterable {
        case local = "local"
        case utc = "utc"
    }
    ...
    open func historyHourlycityIdcityIdGet(cityId: String, startDate: String, endDate: String, key: String, units: HistoryHourlycityIdcityIdGetUnits? = nil, lang: HistoryHourlycityIdcityIdGetLang? = nil, tz: HistoryHourlycityIdcityIdGetTz? = nil, callback: String? = nil) -> AnyPublisher<History, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var path = "/history/hourly?city_id&#x3D;{city_id}"
    ...
    /// Enum for parameter units
    ///
    public enum HistoryHourlycitycitycountrycountryGetUnits: String, Codable, CaseIterable {
        case s = "S"
        case i = "I"
    }
    ///
    /// Enum for parameter lang
    ///
    public enum HistoryHourlycitycitycountrycountryGetLang: String, Codable, CaseIterable {
        case ar = "ar"
        case az = "az"
        case be = "be"
        case bg = "bg"
    ...
    /// Enum for parameter tz
    ///
    public enum HistoryHourlycitycitycountrycountryGetTz: String, Codable, CaseIterable {
        case local = "local"
        case utc = "utc"
    }
    ...
    /// - parameter callback: (query) Wraps return in jsonp callback. Example: callback&#x3D;func (optional)
    /// - returns: AnyPublisher<History, Error> 
    open func historyHourlycitycitycountrycountryGet(city: String, country: String, startDate: String, endDate: String, key: String, state: String? = nil, units: HistoryHourlycitycitycountrycountryGetUnits? = nil, lang: HistoryHourlycitycitycountrycountryGetLang? = nil, tz: HistoryHourlycitycitycountrycountryGetTz? = nil, callback: String? = nil) -> AnyPublisher<History, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var path = "/history/hourly?city&#x3D;{city}&amp;country&#x3D;{country}"
    ...
    /// Enum for parameter units
    ///
    public enum HistoryHourlylatlatlonlonGetUnits: String, Codable, CaseIterable {
        case s = "S"
        case i = "I"
    }
    ///
    /// Enum for parameter lang
    ///
    public enum HistoryHourlylatlatlonlonGetLang: String, Codable, CaseIterable {
        case ar = "ar"
        case az = "az"
        case be = "be"
        case bg = "bg"
    ...
    /// Enum for parameter tz
    ///
    public enum HistoryHourlylatlatlonlonGetTz: String, Codable, CaseIterable {
        case local = "local"
        case utc = "utc"
    }
    ...
    /// - parameter callback: (query) Wraps return in jsonp callback. Example: callback&#x3D;func (optional)
    /// - returns: AnyPublisher<History, Error> 
    open func historyHourlylatlatlonlonGet(lat: Double, lon: Double, startDate: String, endDate: String, key: String, units: HistoryHourlylatlatlonlonGetUnits? = nil, lang: HistoryHourlylatlatlonlonGetLang? = nil, tz: HistoryHourlylatlatlonlonGetTz? = nil, callback: String? = nil) -> AnyPublisher<History, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var path = "/history/hourly?lat&#x3D;{lat}&amp;lon&#x3D;{lon}"
    ...
    /// Enum for parameter units
    ///
    public enum HistoryHourlypostalCodepostalCodeGetUnits: String, Codable, CaseIterable {
        case s = "S"
        case i = "I"
    }
    ///
    /// Enum for parameter lang
    ///
    public enum HistoryHourlypostalCodepostalCodeGetLang: String, Codable, CaseIterable {
        case ar = "ar"
        case az = "az"
        case be = "be"
        case bg = "bg"
    ...
    /// Enum for parameter tz
    ///
    public enum HistoryHourlypostalCodepostalCodeGetTz: String, Codable, CaseIterable {
        case local = "local"
        case utc = "utc"
    }
    ...
    /// - parameter callback: (query) Wraps return in jsonp callback. Example: callback&#x3D;func (optional)
    /// - returns: AnyPublisher<History, Error> 
    open func historyHourlypostalCodepostalCodeGet(postalCode: String, startDate: String, endDate: String, key: String, country: String? = nil, units: HistoryHourlypostalCodepostalCodeGetUnits? = nil, lang: HistoryHourlypostalCodepostalCodeGetLang? = nil, tz: HistoryHourlypostalCodepostalCodeGetTz? = nil, callback: String? = nil) -> AnyPublisher<History, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var path = "/history/hourly?postal_code&#x3D;{postal_code}"
    ...
    /// Enum for parameter units
    ///
    public enum HistoryHourlystationstationGetUnits: String, Codable, CaseIterable {
        case s = "S"
        case i = "I"
    }
    ///
    /// Enum for parameter lang
    ///
    public enum HistoryHourlystationstationGetLang: String, Codable, CaseIterable {
        case ar = "ar"
        case az = "az"
        case be = "be"
        case bg = "bg"
    ...
    /// Enum for parameter tz
    ///
    public enum HistoryHourlystationstationGetTz: String, Codable, CaseIterable {
        case local = "local"
        case utc = "utc"
    }
    ...
    /// - parameter callback: (query) Wraps return in jsonp callback. Example: callback&#x3D;func (optional)
    /// - returns: AnyPublisher<History, Error> 
    open func historyHourlystationstationGet(station: String, startDate: String, endDate: String, key: String, units: HistoryHourlystationstationGetUnits? = nil, lang: HistoryHourlystationstationGetLang? = nil, tz: HistoryHourlystationstationGetTz? = nil, callback: String? = nil) -> AnyPublisher<History, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var path = "/history/hourly?station&#x3D;{station}"
