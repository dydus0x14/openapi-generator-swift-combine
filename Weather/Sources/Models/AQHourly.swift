...
public struct AQHourly: Codable {
    /// City Name
    ...
    public var data: [AQHour]?

    public init(cityName: String? = nil, stateCode: String? = nil, countryCode: String? = nil, lat: String? = nil, lon: String? = nil, timezone: String? = nil, data: [AQHour]? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent([AQHour].self, forKey: .data)
    }
