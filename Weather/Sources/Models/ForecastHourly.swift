...
public struct ForecastHourly: Codable {
    ...
    public var data: [ForecastHour]?

    public init(cityName: String? = nil, stateCode: String? = nil, countryCode: String? = nil, lat: String? = nil, lon: String? = nil, timezone: String? = nil, data: [ForecastHour]? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent([ForecastHour].self, forKey: .data)
    }
